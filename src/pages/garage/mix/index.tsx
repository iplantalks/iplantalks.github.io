...
export default function Page() {
  ...
  return <main>
    ...
    <div className="container py-5">
      ...
      <p>Розрахунок відбуваеється у процентах відносно дати початку розрахунку, так наприклад, якщо акція на початок розрахунків коштувала 50 долларів, а теперь коштує 80 - доіхдність складатиме - (80-50)/50*100 = 60%</p>
