  ...
  return (
    <main>
      ...
      <div className="container py-5">
        ...
        <p>
          Примітка: після того як проголосуєте за маршрут, якщо все добре, буде показано повідомлення про те що голос зараховано, але сама цифра зміниться лише через декілька хвилин. Справа в тому, що
          для швидкості та адекватної вартості, відповіді Google Sheets кєшуються, тобто сторінка показує вам закешовані данні, які обновляются раз у декілька хвилин, а отже важ голос зʼявиться трохи
          піздніше. Тож не хвилюйтеся і якщо побачили повідомлення що голос враховано - так воно і є.
        </p>
      </div>
