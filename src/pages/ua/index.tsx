...
const Market = () => {
  ...
  return (
    <main>
      ...
      <div className="container mx-auto my-5 p-4 space-y-4">
        <h1 className='text-2xl font-bold'>Ураїнскій Ринок 🇺🇦</h1>
        <h2 className='text-xl font-bold'>Гривня через 20 років або Прибуткові ігри*</h2>
        ...
        <h3 className='text-xl font-bold'>Стартовые параметры инвестирования: сумма – 10000 грн, январь 1998, 2008, 2013 гг.</h3>
        ...
        <h3 className='text-xl font-bold'>За підсумками аналізу, трійка лідерів найприбутковіших інвестиційних інструментів виглядає так:</h3>

        <ol className='list-decimal list-inside ml-5'>
          <li>
            <b>За период 1998-2018г</b>
            <ol className='list-decimal list-inside ml-5' type="a">
