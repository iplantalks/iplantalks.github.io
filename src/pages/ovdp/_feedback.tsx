  ...
  return (
    <div className="text-bg-primary">
      <div className="container py-5">
        ...
        <p>Або ще краще, доєднуйтесь до спільноти, де ви зможете поділитися своїми знахідками з однодумцями не дочикуючись поки ми виправимо помилку або додамо нову плюшку.</p>
        <iframe
          width="560"
          height="315"
