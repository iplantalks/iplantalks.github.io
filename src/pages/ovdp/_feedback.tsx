  ...
  return (
    <div className="bg-sky-700 text-white">
      <div className="container mx-auto my-0 p-4 py-8">
        ...
        <p className='mb-3'>Звісно, неможливо услідкувати за усіма пропозиціями, та передбачити усі побажання.</p>
        ...
        <p className='mb-3'>Або ще краще, <a className='text-blue-500' href="https://cutt.ly/2e460oFu" target="_blank">доєднуйтесь до спільноти</a>, де ви зможете поділитися своїми знахідками з однодумцями не дочикуючись поки ми виправимо помилку або додамо нову плюшку.</p>
        <iframe
