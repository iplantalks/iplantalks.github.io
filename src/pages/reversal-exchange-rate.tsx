  ...
  return (
    <main>
      ...
      <div className="container py-5">
        ...
        <p>Ви хочете проінвестували її на {years} років, в депозити, ОВДП, або інші інструменти.</p>
        <p>
          Наразі ви бачите, що скажімо в гривні (депозит, ОВДП) можна отримати &mdash; <span className="text-primary">{expectedReturnUah}%</span> річних, а в валюті &mdash;{' '}
        ...
        <div className="alert alert-secondary">
          Постає питання: Що ефективніше - покласти зараз існуючу валюту на доларовий вклад, чи обміняти все на гривню, інвестувати в гривневий інструмент під більший відсоток, а через
          {years} років на отриману суму знову купити валюту?
        </div>
        <p>&nbsp;</p>
        <p>Прийняття рішення якраз і спрощує цей калькулятор. Давайте введемо дані з прикладу.</p>
